...
So far, we've discussed the first three steps in the hypothesis testing process of the z-test for the population mean $(\mu)$. The last step is to draw conclusions.
...
:hint: $z = (550 - 500)/(100/\sqrt{25})$.
:feedback-0: Correct! The standard error shrinks to $100/\sqrt{25} = 20$, so $z = 50/20 = 2.5$.
:feedback-1: $z = 1$ was the value for $n = 4$; with $n = 25$ the standard error is smaller, so z is larger.
:feedback-2: Remember to divide $\sigma$ by $\sqrt{n}$: $100/\sqrt{25} = 20$.
* *$z = 2.5$
* $z = 1$
* $z = 0.5$
:::
