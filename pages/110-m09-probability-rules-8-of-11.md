...
The key here is to use the fact that the complement event is much easier to deal with than the actual event of interest. Going back to our examples:
...
:::{admonition} Example: At Least One of Two
:class: tip
...
:::{admonition} Example: At Least One of Ten
:class: tip
...
Let's decide on some notations. Let L be the event that the student gets at least one of the questions right. We'll use R for getting a question right and W for getting it wrong (W is essentially "not R").
