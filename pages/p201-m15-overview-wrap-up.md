...
- If the p-value is below the significance level $\alpha$ (usually 0.05), we reject $H_0$ and accept $H_a$; the results are {term}`statistically significant`. Otherwise we conclude that the data do not provide enough evidence to reject $H_0$—which is *not* the same as accepting $H_0$.
...
:feedback-0: Correct! $H_0$: the proportion of low-birth-weight babies among smokers is 0.078 (same as the general population); $H_a$: the proportion is higher than 0.078.
...
* *$H_0$: the proportion among smokers is 0.078; $H_a$: the proportion among smokers is higher than 0.078
* $H_0$: the proportion among smokers is higher than 0.078; $H_a$: the proportion is 0.078
* $H_0$: the proportion among smokers is 0.078; $H_a$: the proportion is not 0.078
:::
...
:feedback-0: Correct! Since $0.016 < 0.05$, we reject $H_0$ and conclude that smoking during pregnancy is associated with an increased proportion of low-birth-weight babies.
...
:hint: The p-value assumes $H_0$ (proportion = 0.078) is true.
