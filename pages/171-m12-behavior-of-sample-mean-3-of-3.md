...
:hint: n = 100 ≥ 30, so the CLT applies: SD of the mean = 500/√100 = 50, z = (2700 − 2600)/50 = 2.
:feedback-0: Correct! By the CLT, x-bar is approximately normal with mean 2,600 and SD 50; z = 2, so P ≈ 0.025.
...
:hint: Mean = μ; SD = 5,000/√64.
:feedback-0: Correct! Mean = \$54,000 and SD = 5,000/8 = \$625.
:feedback-1: Divide σ by √64 = 8, not by 64.
...
:feedback-1: 0.34 would correspond to z ≈ −0.4; here the z-score is −3.2, far in the tail.
...
:hint: The population is normal, so x-bar is normal for any n. SD of the mean = 111/√4 = 55.5; z = (600 − 507)/55.5 ≈ 1.68.
:feedback-0: Correct! Since the population is normal, x-bar is normal even for n = 4: z = 1.68, so P ≈ 0.0465.
:feedback-1: The CLT rule of thumb (n ≥ 30) is unnecessary here—the population itself is normal, so the sample mean is normal for any n.
:feedback-2: Remember to divide σ by √4 before standardizing.
* *About 0.046
