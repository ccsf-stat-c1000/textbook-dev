...
2. The general form of confidence intervals is: $\text{point estimate} \pm \text{margin of error}$ where the margin of error represents the maximum estimation error for a given level of confidence, and is the product of the confidence multiplier and the standard deviation (or standard error) of the point estimator.
