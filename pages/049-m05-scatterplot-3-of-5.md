...
```{figure} images/scatterplot15.gif
:alt: A scatterplot. The Y-Axis is labeled "Sign Legibility Distance (feet)", and the X-axis is labeled "Driver Age (years)" There are 30 points on the plot.
```
...
```{figure} images/scatterplot16.gif
:alt: A line from the upper left of the plot to the lower right has been drawn. The points of the scatterplot roughly follow this line.
```
