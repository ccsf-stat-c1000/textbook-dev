...
:alt: The scatterplot of driver age against sign legibility distance for the 30 drivers. The points drift downward from left to right.
```
...
```{figure} images/gen/m05-signs-scatterplot-trend.svg
:alt: The same scatterplot with a red arrow drawn from the upper left down to the lower right. The points roughly follow this downward line, illustrating the negative direction of the relationship.
```
