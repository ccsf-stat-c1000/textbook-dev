...
Finally, we have one piece of unfinished business left from this module. We have only discussed the version of the Multiplication Rule that is restricted to independent events, and we still need to lift this restriction and introduce the General Multiplication Rule. This will be done in the next module.

## Reflect

Before moving on, check your understanding:

- Can you state the five basic probability rules and recognize which one a problem calls for?
- Can you explain the difference between disjoint events and independent events, and why disjoint events are never independent?
- Given a "…at least one…" problem, can you solve it with the Complement Rule?
- Can you build and read a two-way probability table?
