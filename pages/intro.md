...
This book introduces you to the core ideas of probability and statistics, the tools researchers, scientists, and analysts use to make sense of data and draw conclusions from it. No prior statistics knowledge is needed, just comfort with intermediate algebra.
...
This content is adapted from *[Probability & Statistics](https://oli.cmu.edu/courses/probability-statistics-open-free/)* (Open & Free), developed by the Open Learning Initiative (OLI) at Carnegie Mellon University.
