...
:hint: Mean = $p = 0.1$; SD = $\sqrt{0.1 \times 0.9/225}$.
:feedback-0: Correct! Mean = 0.1 and SD = $\sqrt{0.09/225} = 0.02$.
:feedback-1: The mean of the sampling distribution is the population proportion 0.1, not the sample size fraction.
:feedback-2: SD = $\sqrt{0.1 \times 0.9/225} = \sqrt{0.0004} = 0.02$, not 0.09.
* *Mean 0.1, SD 0.02
* Mean 0.5, SD 0.02
* Mean 0.1, SD 0.09
:::
...
:feedback-1: Recheck: np = $225 \times 0.1 = 22.5 \geq 10$.
...
:hint: Use mean $\pm 2$ SD: $0.1 \pm 2(0.02)$.
:feedback-0: Correct! $0.1 \pm 0.04$ gives the interval (0.06, 0.14).
:feedback-1: (0.08, 0.12) is mean $\pm 1$ SD, which covers only about 68%.
