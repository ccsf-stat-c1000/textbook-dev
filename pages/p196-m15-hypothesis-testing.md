...
We are now moving to the other kind of inference, {term}`hypothesis testing`. We say that hypothesis testing is "the other kind" because, unlike the inferential methods we presented so far, where the goal was *estimating* the unknown parameter, the idea, logic and goal of hypothesis testing are quite different.

In the first part of this module we will discuss the idea behind hypothesis testing, explain how it works, and introduce new terminology that emerges in this form of inference. The next two parts will be more specific and will discuss hypothesis testing for the population proportion (p), and for the population mean $(\mu)$.
