...
```{figure} images/gen/m05-fire-scatterplot.svg
:alt: A scatterplot with the number of firefighters sent on the horizontal axis and the amount of fire damage on the vertical axis. The points rise steadily from lower left to upper right, showing a fairly strong positive relationship.
```
...
```{figure} images/gen/m05-lurking-diagram.svg
