...
:::{quiz} The probability is 0.10 that a standardized normal variable takes a value below what value of z? (From the table, P(Z < $-1.28) \approx 0.1003.)$
:hint: Look for 0.10 inside the table and read the z from the margins.
:feedback-0: Correct! $z \approx -1.28$: the probability is 0.10 of falling more than 1.28 standard deviations below the mean.
