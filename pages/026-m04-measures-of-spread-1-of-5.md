...
```{figure} images/gen/m04-spread-two-dotplots.svg
:alt: Two dotplots of exam scores. In Class A the median is approximately 70, but the scores stretch from about 45 up to 95. In Class B the median is again about 70, but the scores only range from about 60 to 80.
```
