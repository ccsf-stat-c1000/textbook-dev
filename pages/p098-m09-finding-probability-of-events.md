...
In this module, we'll first reintroduce probability, but this time in a more formal way, in a section called *Sample Spaces and Events*. We will then establish the basic methods and principles for finding probabilities of events, which will be organized in two sections: *Equally Likely Outcomes* and *Probability Rules*.
