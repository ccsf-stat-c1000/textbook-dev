...
| --- | --- | --- |
| [40–50) | 1 | $1/15 \approx 0.07$ |
| [50–60) | 2 | $2/15 \approx 0.13$ |
| [60–70) | 4 | $4/15 \approx 0.27$ |
...
2. What is the percentage of exam scores that are at least 70? To determine the answer, we need to:
   ...
   - To get the percentage, multiply the calculated relative frequency by 100. In this case, it would be $0.53 \times 100 = 53$ or 53%.
::::
