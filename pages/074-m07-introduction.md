...
The type of design used, and the details of the design, are crucial, since they will determine what kind of conclusions we may draw from the results. In particular, a key principle of statistics—one that is examined closely when we study relationships between variables in the Exploratory Data Analysis unit—is that an *association* between two variables (the variables tending to change together) does not guarantee that a *causal* relationship exists. In this module, we will explore how the details of a study design play a crucial role in determining our ability to establish evidence of causation.
