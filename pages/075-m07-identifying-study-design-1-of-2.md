...
:::{admonition} Example: TV and Snacking
:class: tip
...
:feedback-0: Correct! The researchers assign the values of the explanatory variable (routine or not), which makes this an experiment.
:feedback-1: In an observational study, the runners themselves would choose whether to stretch.
:feedback-2: A sample survey would ask runners to report on their own stretching and injuries.
* *An experiment
* An observational study
* A sample survey
:::

:::{quiz} A researcher asks 500 adults to report how many hours they slept last night and how stressed they currently feel, then examines the relationship. What type of study is this?
:hint: Did the researcher assign anyone's amount of sleep?
:feedback-0: An experiment would require the researcher to control how long each person sleeps.
:feedback-1: Correct! The values are self-reported as they naturally occur, with no interference—an observational study (specifically a survey).
:feedback-2: There is a design here: it is observational, based on self-reports.
* An experiment
* *An observational study (survey)
* Neither—this is not a study design
:::
