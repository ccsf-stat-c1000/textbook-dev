...
## Tests About $\mu$ When $\sigma$ Is Known: The z-Test for the Population Mean

In this section, we will proceed under the assumption that the population standard deviation $(\sigma)$ is known. We've already discussed the practicality of this assumption. In most situations, the population standard deviation is not known, but in some cases, especially when the variable of interest has been investigated thoroughly over the years, it would make sense to assume that $\sigma$ is known. Such variables are, for example, IQs and other standardized test scores, or heights, weights, and other physical characteristics.
...
*Comment:* this is a situation where it is quite reasonable to assume that the population standard deviation $(\sigma)$ is known. SAT tests are constructed so that the standard deviation is 100, and provided that there is nothing special about students at Ross College, we can assume that $\sigma = 100$ in the population of Ross College students.
...
*Comment:* here it is not that clear why the assumption that $\sigma$ is known to be 12 is reasonable. If shipments are checked on a regular basis, then maybe past experience has shown that indeed $\sigma = 12$. In any case, we will come back to this problem and discuss this point again later.
