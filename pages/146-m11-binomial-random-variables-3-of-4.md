...
| --- | --- | --- |
| 0 | 1 | 1 × (0.4)⁰(0.6)⁴ = 0.1296 |
| 1 | 4 | 4 × (0.4)¹(0.6)³ = 0.3456 |
| 2 | 6 | 6 × (0.4)²(0.6)² = 0.3456 |
| 3 | 4 | 4 × (0.4)³(0.6)¹ = 0.1536 |
| 4 | 1 | 1 × (0.4)⁴(0.6)⁰ = 0.0256 |
...
:hint: P(X = 0) = (0.6)⁴.
:feedback-0: Correct! P(X = 0) = 1 × (0.4)⁰(0.6)⁴ = 0.1296.
...
Suppose the airline sells 50 tickets. Now we have n = 50 and p = 0.90. We want to know P(X > 45), which is 1 − P(X ≤ 45) = 1 − 0.57 = 0.43. (The details of this calculation are done with statistical software or a calculator.) This is certainly more than 0.05, so the airline must sell fewer seats.
