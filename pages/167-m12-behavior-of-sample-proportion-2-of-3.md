...
:hint: Mean = p; SD = √(p(1−p)/n) = √(0.62 × 0.38/100).
:feedback-0: Correct! Mean = 0.62 and SD = √0.002356 ≈ 0.049.
:feedback-1: The mean of the sampling distribution equals the population proportion, 0.62—not 0.5.
:feedback-2: Don't forget to divide by n inside the square root: √(0.62 × 0.38/100) ≈ 0.049.
* *Mean 0.62, SD ≈ 0.049
* Mean 0.5, SD ≈ 0.049
* Mean 0.62, SD ≈ 0.485
:::
...
:feedback-1: Compare with the ordinary range 0.62 ± 2(0.049) = (0.52, 0.72): 0.50 falls outside it.
...
:feedback-1: The mean is close to 0.10 in every case; the problem is the shape, governed by whether np ≥ 10.
