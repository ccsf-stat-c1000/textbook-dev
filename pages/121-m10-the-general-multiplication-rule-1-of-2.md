...
:feedback-0: Correct! P(D1 and D2) = P(D1) × P(D2 | D1) = (2/5) × (1/4) = 2/20 = 0.1.
:feedback-1: (2/5)² would be right only with replacement—but you don't put the first battery back.
