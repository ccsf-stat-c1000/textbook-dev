...
| x | 0 | 1 | 2 | 3 |
| --- | --- | --- | --- | --- |
| P(X = x) | $1(3/4)^3$ | $3(1/4)^1(3/4)^2$ | $3(1/4)^2(3/4)^1$ | $1(1/4)^3$ |
:::
...
P(X = x) = (number of possible outcomes with x successes out of $3) \times$ (probability of each outcome that has x successes out of 3)
...
Note that n! is read "n factorial" and is defined to be the product $1 \times 2 \times 3 \times$ ... $\times n$. 0! is defined to be 1.
...
:hint: Compute $5!/(2! \cdot 3!)$.
:feedback-0: Correct! 5!/(2!3!) = $120/(2 \times 6) = 10$.
