...
1. Find Q1, the median, and Q3. Q1 = $266 - 0.67(16) \approx 255$; median = mean = 266; Q3 = $266 + 0.67(16) \approx 277$. Thus, the probability is 1/4 that a pregnancy will last less than 255 days; 1/2 that it will last less than 266 days; 3/4 that it will last less than 277 days.
...
:hint: Standardize first: $z = (700 - 507)/111 \approx 1.74$, then find the upper-tail probability.
...
:hint: Standardize both: $z = (400 - 507)/111 \approx -0.96$ and $z = (600 - 507)/111 \approx 0.84$; then subtract left-tail areas $(0.7995 - 0.1685)$.
